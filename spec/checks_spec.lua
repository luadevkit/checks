  ...
  describe("#check_types", function()
    ...
    describe("with multiple specifiers", function()
      ...
      it("should use the custom check", function()
        assert.error(function() checks.register('obejct') end)
        checks.register("object", function() return true end)
        assert.not_error(function() f5(1) end)
        checks.register("object", nil)
        assert.error(function() f5(1) end)
      end)
    end)
  end)
  describe("#check_type", function()
    local function check_type0()
      return function()
        checks.check_type()
      end
    end
    local function check_type(...)
      local args = table.pack(...)
      return function()
        checks.check_type(table.unpack(args))
      end
    end
    local function f0(arg, tag)
      local function f()
        checks.check_type(arg, tag)
      end
      return function()
        f()
      end
    ...
    describe("with any", function()
      it("should accept anything but nil", function()
        assert.error(f1(1, 'any', nil), "bad argument #1 to 'f' (not nil expected, got nil)")
      end)
    end)
    describe("blame site", function()
      it("blames the call site", function()
  ...
  describe("#check_option", function()
    ...
    describe("with enum types", function()
      ...
      it("matches types", function()
        ...
        assert.not_error(f1(1, '?one|two', nil))
      end)
    end)
    describe("blame site", function()
      it("blames the call site", function()
